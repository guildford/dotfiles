...
export PS1='------------------------------------------------------------------------\n [ mac == \[\e[32m\][\[\e[35m\]\u\[\e[m\]@ \[\e[36m\]\h \[\e[31m\]\w\[\e[32m\]]\[\e[36m\]$\[\e[m\] \t]'
exec bash
export PS2="| => "

#   Set Paths
#   ------------------------------------------------------------
export PATH="/usr/local/git/bin:/sw/bin/:/usr/local/bin:/usr/local/:/usr/local/sbin:/usr/local/mysql/bin:/Users/jinyongyang/anaconda3/bin:$PATH"
